			...
			<div class="card-body">
				<div class="container-fluid">
						...
						<div class="input-group">
	                        <input type="search" id="keyword" class="form-control form-control-sm" value="<?php echo isset($_GET['keyword']) ? $_GET['keyword'] : '' ?>" placeholder="Escriba su búsqueda aquí">
						...
						<table width="100%">
							...
							<tr>
								...
								<td width="70%">
									...
									<span class="float-right"><span><i>Fecha de creación</i>:</span> <span class="badge badge-light ticket-created"></span></span>
								</td>
...
<script>
	...
	$(document).ready(function(){
		...
		$('#new_data').click(function(){
			uni_modal('<span class="fa fa-plus"></span> Crear nuevo tipo de servicio',_base_url_+'admin/services/manage_category.php')
		})
