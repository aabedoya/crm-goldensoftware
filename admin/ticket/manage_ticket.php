...
<div class="container-fluid">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title"><?php echo !isset($_GET['id']) ? "<span class='fa fa-plus'></span> Crear nuevo" : "<span class='fa fa-edit'></span> Administrar" ?> Titcket</h5>
		</div>
		<div class="card-body">
			<div class="container-fluid">
				<form action="" id="manage-ticket">
					...
					<div class="form-group">
						<label for="service_id" class="control-label">Necesita soporte en:</label>
