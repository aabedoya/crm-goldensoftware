...
<div class="callout">
	...
	<tr>
		...
		<th>
			...
			<span class="float-right"><span><i>Fecha de creación</i>:</span> <span class="badge badge-light ticket-created"><?php echo date("Y-m-d h:i A",strtotime($date_created)) ?></span></span>
		</th>
	</tr>
	</table>
</div>
		...
		<div class="callout callout-info comment-item">
			<table class="table">
				...
				<tr>
					...
					<td>
						<h5 class="comment-user">ejemplo</h5>
						<small class="comment-date">Fecha: <?php echo date("Y-m-d h:i A",strtotime($date_created)) ?></small>
						<hr class="border-primary">
...
<script type="text/javascript">
	...
	function data_func(){
		$('.delete-comment').click(function(){
			_conf('Esta seguro de borrar este comentario?','delete_data',[$(this).attr('data-id')]);
		})
	}
