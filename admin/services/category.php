<br>
<h5 class="">Tipos de servicios</h5>
<hr>
<div class="row">
	<div class="container-fluid">
		<div class="card card-outline card-primary">
			<div class="card-header">
				<h5 class="card-title">Lista de los tipos de servicios</h5>
...
<script>
	...
	function data_func(){
		$('.edit_data').click(function(){
			uni_modal('<span class="fa fa-edit text-primary"></span> Editar tipo de servicio',_base_url_+'admin/services/manage_category.php?id='+$(this).attr('data-id'))
		})
