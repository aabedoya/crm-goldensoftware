...
<div class="container-fluid">
	<form action="" id="manage-service">
		...
		<div class="form-group">
			<label for="category_id" class="control-label">Tipo</label>
			...
			$.ajax({
				...
				success:function(resp){
					if(!!resp.status && resp.status =='success'){
						...
						$('#manage-service').prepend('<div class="form-group err_msg"><div class="callout callout-danger"><span class="fa fa-exclamation-triangle"><b>Servicio ya existe.</b></div></div>');
