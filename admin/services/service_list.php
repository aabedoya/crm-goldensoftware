		...
		<div class="card card-outline card-primary">
			<div class="card-header">
				...
				<div class="card-tools">
					<button class="btn btn-flat btn-primary btn-sm" type="button" id="new_data"><span class="fa fa-plus"></span> Nuevo Servicio</button>
				</div>
			</div>
			<div class="card-body">
				<div class="container-fluid">
...
<script>
	...
	$(document).ready(function(){
		...
		$('#new_data').click(function(){
			uni_modal('<span class="fa fa-plus"></span> Crear nuevo servicio',_base_url_+'admin/services/manage_services.php')
		})
	})
</script>