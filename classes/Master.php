...
Class Master extends DBConnection {
	...
	function delete_ticket(){
		...
		if($delete){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',' Ticket borrado correctamente');
		}else{
			$resp['status'] = 'error';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_ticket(){
		...
		if($save){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',' Ticket guadado correctamente');
		}else{
			$resp['error'] = 'error';
			$resp['data'] = $sql;
		}
	...
	function save_comment(){
		...
		if($save){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',' Comentario posteado correctamente');
		}else{
			$resp['error'] = 'error';
			$resp['data'] = $sql;
		}
	...
	function ticket_update_status(){
		...
		if($this->conn->query($sql)){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',' Ticket\'s actualizados correctamente.');
		}else{
			$resp['status'] = 'error';
			$resp['sql'] = $sql;
		}
